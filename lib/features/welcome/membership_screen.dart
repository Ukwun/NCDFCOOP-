      ...
      child: Column(
        ...
        children: [
          ...
          _buildJourneyStep(
            ...
            description:
                'Browse our selection of fresh products and place your first order',
            icon: '🛒',
          ),
          _buildJourneyStep(
            number: '2',
            ...
            description:
                'Each purchase automatically earns you member discounts and rewards',
            icon: '💰',
          ),
          _buildJourneyStep(
            number: '3',
            ...
            description:
                'As you spend more, unlock Gold and Platinum membership benefits',
            icon: '⭐',
          ),
          _buildJourneyStep(
            number: '4',
            ...
            description:
                'Share in the profits generated by our cooperative community',
            icon: '🎁',
          ),
