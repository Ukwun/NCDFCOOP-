...
class SalesMetric {
  ...
  /// Alias for dailySales for compatibility
  double get totalSales => dailySales;
}
...
class FranchiseInventoryItem {
  ...
  /// Alias for safetyStock
  int get minimumLevel => safetyStock;

  /// Calculate profit (assuming 40% margin)
  double get profit => quantity * unitCost * 0.4;
...
/// Staff member for franchise stores
class StaffMember {
  final String id;
  final String storeId;
  final String name;
  ...
  Map<String, dynamic> toFirestore() {
    return {
      ...
      'terminationDate':
          terminationDate != null ? Timestamp.fromDate(terminationDate!) : null,
    };
  }

  /// Number of orders processed by this staff member
  int get ordersProcessed => (performanceScore * 10).toInt();

  /// Total sales amount generated by this staff member
  double get totalSales => performanceScore * 500;

  /// Commission earned by this staff member
  double get commission => totalSales * 0.05;
